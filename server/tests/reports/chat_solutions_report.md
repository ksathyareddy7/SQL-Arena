...
### ✅ PASS : CHAT_013 - Active online users
```sql
...
### ✅ PASS : CHAT_013 - Grouped online users
```sql
...
### ✅ PASS : CHAT_043 - User-level NOT EXISTS
```sql
...
### ✅ PASS : CHAT_043 - CTE active users anti-join
```sql
...
### ✅ PASS : CHAT_043 - Grouped user message count
```sql
...
### ✅ PASS : CHAT_067 - No messages (exists)
```sql
...
### ✅ PASS : CHAT_076 - Top 3 rank range
```sql
